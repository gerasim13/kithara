...
use kithara_test_fixtures::assets::{signal_mp3_track_sine440_187s, signal_wav_sine440_1s};
...
/// One second of a 44.1 kHz stereo 440 Hz tone, generated by the fixture store.
fn tone_wav() -> &'static [u8] {
    signal_wav_sine440_1s().bytes()
}

/// The generated full-length MPEG clip.
fn tone_mp3() -> &'static [u8] {
...
#[case::wav(true, "wav")]
#[case::mp3(false, "mp3")]
fn decode_with_probe(#[case] use_wav: bool, #[case] ext: &str) {
...
#[case::wav(true, "wav")]
#[case::mp3(false, "mp3")]
fn decode_complete(#[case] use_wav: bool, #[case] ext: &str) {
    let data = if use_wav { tone_wav() } else { tone_mp3() };
    let reader = Cursor::new(data);
...
#[case::wav(true)]
#[case::mp3(false)]
fn from_media_info(wav_media_info: MediaInfo, mp3_media_info: MediaInfo, #[case] use_wav: bool) {
...
#[case::wav("wav")]
#[case::mp3("mp3")]
fn spec_properties(#[case] ext: &str) {
...
#[kithara::test]
fn truncated_data_handles_gracefully() {
