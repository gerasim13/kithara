...
impl HlsFixtureBuilder {
    ...
    #[must_use]
    pub fn packaged_audio_aac_he(self, sample_rate: u32, channels: u16) -> Self {
        self.packaged_audio_signal_aac_he(sample_rate, channels, PackagedSignal::Sawtooth)
    }
