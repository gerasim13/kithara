...
//! that runs outside a `#[kithara_test_utils::kithara::test]` body — where the macro's lexical
...
//! the `#[kithara_test_utils::kithara::flash]` guard macro: it is a no-op off the `flash` feature and
