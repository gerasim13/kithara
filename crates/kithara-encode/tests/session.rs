use kithara_encode::{ContainerSession, EncodeConfig, EncodeError, EncoderSession};
...
mod chunked {
    use kithara_encode::{
        ContainerFinish, ContainerSession, ContainerWrite, EncodeConfig, EncoderSession,
    };
