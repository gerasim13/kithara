...
impl MiniWavePaint<'_> {
    ...
    fn program(&self) -> WavePaint<'_> {
        ...
        WavePaint {
            ...
            overlay,
            palette: WavePalette {
                bg_deep: self.skin.palette.bg_deep,
                line: self.skin.palette.line,
                text_dim: self.skin.palette.text_dim,
                accent: self.skin.palette.accent,
                accent_strong: self.skin.palette.accent_strong,
                wave_low: self.skin.palette.wave_low,
                wave_mid: self.skin.palette.wave_mid,
                wave_high: self.skin.palette.wave_high,
            },
