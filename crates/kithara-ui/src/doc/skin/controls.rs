...
skin_section! {
    pub struct VuStereoSkin => VuStereoPatch {
        pub size: SizeSpec,
...
skin_section! {
    pub struct VuVerticalSkin => VuVerticalPatch {
        pub thumb_color: ColorRole,
        pub thumb_notch_color: ColorRole,
        pub size: SizeSpec,
        pub ticks: TickSkin,
...
skin_section! {
    pub struct RangeSkin => RangePatch {
        pub rail_background: ColorRole,
...
skin_section! {
    pub struct TabLargeSkin => TabLargePatch {
        pub height: f32,
        pub pad_x: f32,
        pub pad_y: f32,
        pub text: TextRoleSkin,
...
skin_section! {
    pub struct SegmentedSkin => SegmentedPatch {
...
skin_section! {
    pub struct SwatchSkin => SwatchPatch {
        pub frame: FrameSkin,
        pub size: SizeSpec,
