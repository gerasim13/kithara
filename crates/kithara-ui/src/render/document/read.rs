...
pub(crate) fn read_scope<'a>(read: Option<&Binding>, ui: &'a CompiledUi) -> &'a str {
    read.map_or("", |binding| {
...
pub(crate) fn read_flag(binding: Option<&Binding>, reads: &dyn Reads, ui: &CompiledUi) -> bool {
    matches!(
...
pub(crate) fn wave_zoom(zoom: Option<&Binding>, reads: &dyn Reads, ui: &CompiledUi) -> f32 {
