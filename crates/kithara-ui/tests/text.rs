...
const BUILTIN_ENTRIES: &[(&str, &str)] = &[
    ...
    ("pivot.title", "ПИВОТ-ПОРТАЛ"),
    ("pivot.master_label", "МАСТЕР"),
    ("pivot.family.ratio_label", "РАТИО"),
    ("pivot.family.step_label", "STEP"),
    ("pivot.family.leap_label", "LEAP"),
    ("pivot.range_label", "ДИАПАЗОН"),
    ("pivot.column.ratio", "РАТИО"),
    ("pivot.column.bpm", "ТЕМП"),
    ("pivot.column.pulse", "ПИВОТ"),
    ("pivot.column.loop", "ЦИКЛ"),
    ("pivot.column.stretch", "ВМЕСТО СТРЕТЧА"),
    ("pivot.loops_label", "ЦИКЛ ДЕКИ"),
    ("pivot.tracks_label", "ТРЕКИ В КОЛЛЕКЦИИ НА ЭТОМ ТЕМПЕ"),
