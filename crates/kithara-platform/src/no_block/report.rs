...
mod consts {
    pub(super) const MAX_ATTEMPT_ID_BYTES: usize = 1_024;
    pub(super) const MAX_CANONICAL_FIELD_BYTES: usize = 512;
    pub(super) const MAX_RUN_ID_BYTES: usize = 1_024;
    pub(super) const SPIN_CPU_FRACTION: f64 = 0.8;
}
