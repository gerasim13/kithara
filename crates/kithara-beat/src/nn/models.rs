...
pub const MEL_MODEL_BYTES: &[u8] = include_bytes!(env!("KITHARA_MEL_MODEL"));

/// ONNX beat model bytes for `BeatThis::builder().beat_model(..)`, from the
/// file the build script resolves for the selected model feature.
#[cfg(any(
