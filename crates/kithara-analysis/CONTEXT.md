...
`BeatAnalysisConfigPatch`, generated by `#[derive(Patch)]`; the backend itself
carries `#[patch(skip)]`. Defaults are 1024-frame mono resampler blocks, 22 050 Hz detector input,
