...
#[derive(Clone, Copy)]
pub(super) struct SessionPosition {
    ...
    S: HasPool<u8> + Send + Sync + 'static,
{
    ...
    pub(super) fn advance_from(&self, position: SessionPosition, bytes: u64) {
    ...
    pub(super) fn projected_position(&self) -> SessionPosition {
...
pub(super) fn pending(reason: PendingReason) -> Error {
