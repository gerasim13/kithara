...
impl Consts {
    ...
    /// + [kithara-decode contracts](https://github.com/zvuk/kithara/wiki/kithara-decode) "Two independent silence layers".
...
impl FrameCodec for SymphoniaCodec {
    ...
    fn priming(&self, codec: AudioCodec) -> CodecPriming {
        // WHY: AAC (incl. HE-AAC seen as AacLc) requests 2 AU of SBR/PS QMF pre-roll after flush ([crate contracts](https://github.com/zvuk/kithara/wiki/kithara-decode) "Seek pre-roll and trim").
        match codec {
...
mod tests {
    ...
    fn symphonia_priming_warms_aac_and_defaults_elsewhere() {
        ...
        // WHY: AAC (incl. HE-AAC seen as AacLc) requests 2-AU SBR pre-roll ([crate contracts](https://github.com/zvuk/kithara/wiki/kithara-decode) "Seek pre-roll and trim").
