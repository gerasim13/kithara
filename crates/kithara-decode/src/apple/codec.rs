...
/// [kithara-decode contracts](https://github.com/zvuk/kithara/wiki/kithara-decode) "Apple AAC and FLAC cookies".
fn esds_wrap_asc(asc: &[u8]) -> DecodeResult<Vec<u8>> {
    ...
    // WHY: ES_Descriptor chain; field layout is documented in [crate contracts](https://github.com/zvuk/kithara/wiki/kithara-decode).
    let header: [u8; 22] = [
