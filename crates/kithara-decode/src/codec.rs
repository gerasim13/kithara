...
pub(crate) const fn access_unit_frames(codec: AudioCodec) -> u32 {
    match codec {
        AudioCodec::Mp3 => 1152,
...
pub(crate) trait FrameCodec: Send + 'static {
    ...
    /// `AudioStreamPacketDescription`); empty for CBR. See [crate contracts](https://github.com/zvuk/kithara/wiki/kithara-decode)
