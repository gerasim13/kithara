...
/// [kithara-audio contracts](https://github.com/zvuk/kithara/wiki/kithara-audio).
...
impl PreloadGate {
    ...
    #[doc(hidden)]
    pub fn is_ready_for_epoch(&self, epoch: u64) -> bool {
    ...
    #[doc(hidden)]
    pub fn signal_epoch(&self, epoch: u64) {
