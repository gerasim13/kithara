...
<tr><td><code>test</code></td><td><code>cfg(any(test, feature = "usdt"))</code></td><td>Re-exports <code>kithara_test_macros::test</code>; <code>init_tracing</code>, <code>setup_tracing</code>, <code>setup_tracing_with_filter</code> helpers</td></tr>
...
<tr><td><code>usdt</code></td><td><code>usdt</code></td><td>USDT probe runtime helpers consumed by code annotated with <code>#[kithara::probe(...)]</code>; <code>noop</code> fallback when disabled</td></tr>
...
Consumer crates typically enable `mock` and `usdt` in their `[dev-dependencies]` while keeping the default `hang` feature on.
